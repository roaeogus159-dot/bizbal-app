...
export const GUIDES: Record<Screen, GuideStep[]> = {
  ...
  convert: [
    ...
    },
    {
      ...
      title: '⑤ 채색 모드',
      text: '"자동"이면 알아서 색을 정해줘요. "전문가"로 바꾸면 원본과 색이 많이 다른 칸을 주황색으로 표시해 줘서 바꿀 곳을 찾기 쉬워요. 재질감 미리보기를 켜면 투명·오로라 완성 느낌도 볼 수 있어요.',
    },
    {
  ...
  editor: [
    ...
    },
    {
      ...
      title: '① 도구 고르기',
      text: '점 선택: 탭한 칸 선택 · 영역: 문지른 칸 모두 선택 · 같은 색: 같은 색 전부 선택 · 스포이드: 색 집어오기. 점 선택 중 길게 누르면 돋보기가 떠서 정밀하게 고를 수 있어요.',
    },
    {
    ...
    },
    {
      target: '[data-guide="actions"]',
      title: '⑤ 다 됐으면 저장!',
      text: '수정이 끝나면 [도안 저장]을 눌러 결과 화면으로 이동하세요.',
    },
  ],
